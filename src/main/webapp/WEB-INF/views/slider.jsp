            ...
            <div class="container">
               <div id="sequence">
                  ...
                  <ul class="sequence-canvas">
                     <li class="animate-in">
                        <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead">CỬA HÀNG LINH KIỆN ĐIỆN TỬ</span></div>
                        <div class="flat-caption caption2 formLeft delay400 text-center">
                           <h1>Linh kiện điện tử</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500 text-center">
                           <p>An toàn<br>Độ bền cao.</p>
                        </div>
                     ...
                     <li>
                        <div class="flat-caption caption2 formLeft delay400">
                           <h1>Linh kiện điện tử chính hãng</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500">
                           <h2>Bảo hành với chất lượng tốt nhất<br>Chu đáo, tận tình hỗ trợ.</h2>
                        </div>
                     ...
                     <li>
                        ...
                        <div class="flat-caption caption3 formLeft delay500 text-center">
                           <p>Đa dạng về mẫu mã và màu sắc <br>Có nhiều sự lựa chọn hơn.</p>
                        </div>
                        <div class="flat-button caption4 formLeft delay600 text-center"><a class="more" href="#">More Details</a></div>
